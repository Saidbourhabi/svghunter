    ...
    <Disclosure
        ...
        <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            ...
            <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
                <DisclosureButton className="group relative inline-flex items-center justify-center p-2 text-[#5b23ff] hover:bg-black/5 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#5b23ff]">
        ...
        <DisclosurePanel className="sm:hidden">
            ...
            {navigation.map((item) => (
                <DisclosureButton
                    ...
                    className={({ isActive }) =>
                    classNames(
                    isActive ? 'bg-black/80 text-white' : 'text-slate-900 hover:bg-black/10',
